...
public class CubeLerp : Photon.MonoBehaviour, IPunObservable
{
    ...
    public void Start()
    {
        //this.latestCorrectPos = new Vector3(0, -2.5f, 0); // чтобы пуля выстреливала оттуда откуда надо из дула
        //this.onUpdatePos = new Vector3(0, -2.5f, 0); // чтобы пуля выстреливала оттуда откуда надо из дула
